...
export default function MapScreen() {
  const { globalAnchors } = useContext(AnchorsContext);
  ...
  const multilaterate = () => {
    const anchorList = Object.values(globalAnchors).filter(
  ...
  const phonePosition = useMemo(() => multilaterate(), [globalAnchors]);
  ...
  return (
    <View style={styles.container}>
      <Svg width={MAP_WIDTH} height={MAP_HEIGHT} style={styles.map}>
        ...
        {Object.values(globalAnchors).map((anchor) => {
